    ...
    <section class="col-lg-9 connectedSortable">
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content no-padding">
          <div class="chart tab-pane active" id="urevenue-chart" style="position: relative; height: 300px;">
            <div class="col-lg-12">
              <div class="row" style="padding: 5px;">
                <div class="card" style="max-height: 245px; overflow-y: auto;">
                ...
                <div class="card">
                  <div class="card-body" style="padding: 8px;">
                    <a href="{{ route('users.index') }}"><button class="btn btn-default pull-right" style="min-width: 150px;">Details</button></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chart tab-pane" id="sales-chart" style="position: relative; height: 300px;">
            <div class="col-lg-12">
              <div class="row" style="padding: 5px;">
                ...
                <div class="card">
                  <div class="card-body" style="padding: 8px;">
                    <a href="{{ route('roles.index') }}"><button class="btn btn-default pull-right" style="min-width: 150px;">Details</button></a>
                  </div>
                </div>
              </div>
            </div>
