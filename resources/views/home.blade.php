          ...
          <div class="box">
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    <span class="description-percentage text-yellow"><i class="fa fa-user-plus"></i> 0 </span>
                    <h5 class="description-header">
                      <div>
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    <span class="description-percentage text-green"><i class="fa fa-book"></i> 0 </span>
                    <h5 class="description-header">
                      <div>
                        <a href="{{ route('profiles.index') }}">
                        ...
                        @else
                          <a href="{{ route('profiles.create') }}" onclick="return confirm('This will change your profile to a company owner under this platform.\nIs this what you want?')">
                ...
                <div class="col-md-3 col-sm-4">
                  <div class="pad box-pane-right bg-green" style="min-height: 280px">
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff">Departments</div>
                      <h5 class="description-header">0</h5>
                      <span class="description-text btn btn-primary">View All</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
