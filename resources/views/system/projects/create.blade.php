...
@section('styles', '') 
@section('page-tree')
    <h1> Add Projects <small> Add new project.</small></h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:void(0)"><i class="fa fa-plus"></i> New Projects </a></li>
    </ol>
@endsection
@section('content')
	<div class="row">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content padding">
                    <div class="chart tab-pane active" id="urevenue-chart" style="position: relative; height: 500px; overflow-y: auto;">
                        <div class="card">
                            <div class="card-header"><h4 style="width: 100%; text-align: center;"> Add Profile </h4></div>
                            <div class="card-body">
