		...
		<section class="col-lg-9 connectedSortable">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs pull-right">
					...
					<li class="pull-left header"><i class="fa fa-edit text-info"></i><a href="{{ route('galleries.index') }}" class="btn btn-xs btn-info pull-left"><i class="fa-angle-left fa"></i> Back</a></li>
				</ul>
                            ...
                            <div class="card-body">
                            	<form action="{{ route('galleries.store') }}" enctype="multipart/form-data" method="POST">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control" name="main_gallery">
                                                            <option value="{{ $gallery->main_gallery }}">Chose to change main gallery</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="size" value="{{ $gallery->size }}" class="form-control" id="image-size" placeholder="the size of the image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="caption" value="{{ $gallery->caption }}" class="form-control" id="caption_text" placeholder="Caption Text">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                    ...
                                    <div div class="col-md-12 text-center">
                                        ...
                                        <button type="submit" class="btn btn-rounded btn-primary" style="min-width: 150px;">Update Gallery</button>
                                    </div>
                                </form>
                            </div>
						</div>
