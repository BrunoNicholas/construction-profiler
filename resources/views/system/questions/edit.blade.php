...
@section('styles', '') 
@section('page-tree')
    <h1> Edit Question <small> Ask a new question.</small></h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:void(0)"><i class="fa fa-edit"></i> Edit Question </a></li>
    </ol>
@endsection
@section('content')
	<div class="row">
		<section class="col-lg-9 connectedSortable">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs pull-right">
					...
					<li class="pull-left header"><i class="fa fa-edit text-info"></i><a href="{{ route('questions.index') }}" class="btn btn-xs btn-info pull-left"><i class="fa-angle-left fa"></i> Back</a></li>
				</ul>
				<div class="tab-content padding">
					<div class="chart tab-pane active" id="urevenue-chart" style="position: relative; height: 500px; overflow-y: auto;">
						<div class="card">
							<div class="card-header"><h4 style="width: 100%; text-align: center;"> Edit Question </h4></div>
                            <div class="card-body">
